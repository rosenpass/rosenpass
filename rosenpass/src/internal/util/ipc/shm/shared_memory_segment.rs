...
///
/// The reason for this is that, per the Rust documentation, any concurrent memory access leads to
...
///
/// The Rust (transitively, from the C++11 atomics) specification tells us that there must be no
