...
impl TryFrom<u8> for SetPskResponseReturnCode {
    ...
    /// # Example
    /// ```
    /// # use crate::internal::wireguard_broker::api::msgs::{InvalidSetPskResponseError, SetPskResponseReturnCode};
...
/// The types of messages supported by [`wireguard_broker`](crate::internal::wireguard_broker). At the time of writing, this is only
...
/// ```
/// # use crate::internal::wireguard_broker::api::msgs::{InvalidMessageTypeError, MsgType};
...
impl TryFrom<u8> for MsgType {
    ...
    /// # Example
    /// ```rust
    /// use crate::internal::wireguard_broker::api::msgs::MsgType;
