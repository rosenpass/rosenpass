...
fn api_integration_api_setup_v02() -> anyhow::Result<()> {
    api_integration_api_setup(cfg::ProtocolVersion::V02)
}

#[test]
fn api_integration_api_setup_v03() -> anyhow::Result<()> {
    api_integration_api_setup(cfg::ProtocolVersion::V03)
}

fn api_integration_api_setup(protocol_version: cfg::ProtocolVersion) -> anyhow::Result<()> {
