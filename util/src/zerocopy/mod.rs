//! This module provides utilities for working with zero-copy references and slices.
//!
//! It offers the following primary abstractions and traits:
//!
//! - [`RefMaker`]: A helper structure for safely creating [`Ref`](zerocopy::Ref) references from byte slices.
